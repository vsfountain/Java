...
public class LoginController {
	...
	private static ReimbursementDao imbur= new  ReimbursementDaoImpl();
	...
	public static String login(HttpServletRequest req) {
		...
		public static int InsertReimbursement(HttpServletRequest req) {

			String username = resp.getParameter("username");
