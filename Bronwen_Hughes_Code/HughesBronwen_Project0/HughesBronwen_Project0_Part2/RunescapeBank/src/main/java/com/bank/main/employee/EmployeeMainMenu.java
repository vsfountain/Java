...
public class EmployeeMainMenu {
	...
	public void register() {
		...
		System.out.println("Employee user is created.");
		System.out.println();
	}

	public boolean adminConfirmation() {
		boolean admin;
		while (true) {
	...
	public void attemptLogin() {
		...
		if(temp) {
			new EmployeePortal(employeeService.getEmployeeFromUsername(username));
		} else if(!temp) {
			while (true) {
				System.out.println("Would you like to try again? [Y/N] ");
