...
import com.ers.controller.UpdateController;
...
public class JSONRequestHelper {
	public static void process(HttpServletRequest request, HttpServletResponse response) throws JsonProcessingException, IOException, ServletException {
		...
		case "/MyERSProject/createReimbursement.json":
			...
			break;
		case "/MyERSProject/updateReimbursement.json":
			System.out.println("update controller called from requesthelper");
			UpdateController.approve(request, response);
			break;
		default:
