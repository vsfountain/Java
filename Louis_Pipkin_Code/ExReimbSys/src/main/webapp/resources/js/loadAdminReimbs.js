...
function setValues(user){
	...
	//document.getElementById('logout').onclick = logoutreq();
...
//		cell8.innerHTML = res;
		...
		if (reimbs[reimb].status == 'Pending') {
			cell10.innerHTML = '<td><input id="checker" type="checkbox" name="selectedRow" value='
					+ reimbs[reimb].reimbId + '></td>';
		}
